...
export default function Badge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full border leading-none font-black tracking-wider uppercase ${v} ${s} ${onClick ? 'cursor-pointer transition-all hover:opacity-80 active:scale-95' : ''} ${className}`}
      onClick={onClick}
